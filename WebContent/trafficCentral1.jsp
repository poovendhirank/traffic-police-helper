	...
	<div id="main">
		...
		<div>
			<div class="heading mt-4 col-md-12 col-sm-12 col-12">
				<h2>Traffic Central Team</h2>
			</div>
			<div class="row justify-content-center my-4 mx-0">
				<div class="mr-4">
					<input type="button" onclick="location.href='trafficCentral1.jsp';"
						value="SOS" class="btn" />
				</div>

				<div>
					<input type="button" onclick="location.href='trafficCentral2.jsp';"
						value="VIOLATIONS" class="btn" />
				</div>
			</div>
			<div class="row m-0">
					...
					<form class="inner1">
						...
						<table id="myTable" border="2" align="center">
							...
							<%
								...
								ResultSet rs = stmt.executeQuery("select* from sosRequest");
								while (rs.next()) {
							%>
							<tbody>
								<tr>
				...
				<div class="col-md-6 col-12 col-sm-12 p-4">
					<form class="inner3" action="deletesosreq" method="post">
						<h1>SEND TEAMS</h1>
						<label>Village :</label> <input type="text" name="village"
							placeholder="Village" /></br> <label>City :</label> <input
							type="text" name="city" placeholder="City" /></br> <label>Pin
							Code :</label> <input type="text" name="pincode" placeholder="Pin Code" /></br>
